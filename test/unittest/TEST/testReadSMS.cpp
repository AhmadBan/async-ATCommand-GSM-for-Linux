...
TEST(SMSCommandTest, SMSReadTestReceive) {
	...
	EXPECT_EQ(0,strcmp("20/12/10",testSms.date));
	EXPECT_EQ(0,strcmp("21:46:48+14",testSms.hour));
	EXPECT_EQ(0,strcmp("Hello world this is 2\nThis is 3\n\n",testSms.message));
	EXPECT_EQ(0,strcmp("+989350542618",testSms.phoneNumber));
	EXPECT_EQ(0,strcmp("REC READ",testSms.status));
	EXPECT_EQ(1,testSms.msgId);

	EXPECT_EQ(ret,0);
}


TEST(SMSCommandTest, SMSReadTestReceiveMultipleSms) {
	int fileDescriptor;
	char filename[]="readSmsFile";
	ReadSMS_t cmd;
	int ret,size;
...
";
	...
	EXPECT_EQ(0,strcmp("20/12/10",testSms.date));
	EXPECT_EQ(0,strcmp("21:53:16+14",testSms.hour));
	EXPECT_EQ(0,strcmp("This is a big sms ififjxhxhxzyh 8duduxuxuxu 8f8fidiiiuuxuxu f8f7dududuxud 9fifdiuuytrfhhgfd hhjkoutrf hhjhffrrfhj.   Yuujjbvcryikjbv hduduxxuxuxufuuu.  8",testSms.message));
	EXPECT_EQ(0,strcmp("+989350542618",testSms.phoneNumber));
	EXPECT_EQ(0,strcmp("REC READ",testSms.status));
	EXPECT_EQ(2,testSms.msgId);
